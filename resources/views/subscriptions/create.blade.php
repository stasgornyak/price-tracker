<x-layouts.app>
    ...
    <!-- Page Title -->
    <div class="mb-6">
        <h1 class="text-2xl font-bold text-gray-800 dark:text-gray-100">{{ __('Add subscription') }}</h1>
    </div>
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="overflow-hidden overflow-x-auto p-6 bg-white border-b border-gray-200">
                    <div class="min-w-full align-middle">
                        ...
                        <form class="max-w-md" method="POST" action="{{ route('subscriptions.store') }}">
                            @csrf
                            ...
                            <div class="mb-4">
                                <x-forms.input :label="__('Url')" name="url" type="text" required
                                               value="{{ old('url') }}" />
                            </div>
