                ...
                <div
                    ...
                    <div class="p-6">
                        ...
                        <form class="max-w-md mb-10" action="{{ route('settings.profile.update') }}" method="POST">
                            ...
                            <div>
                                <x-buttons.common-button variant="primary">{{ __('Save') }}</x-buttons.common-button>
                            </div>
                        </form>
                        ...
                        <div class="border-t border-gray-200 dark:border-gray-700 pt-6 mt-6">
                            ...
                            <form action="{{ route('settings.profile.destroy') }}" method="POST"
                                ...
                                @csrf
                                @method('DELETE')
                                <x-buttons.common-button variant="danger">{{ __('Delete account') }}</x-buttons.common-button>
                            </form>
                        </div>
                    </div>
                </div>
